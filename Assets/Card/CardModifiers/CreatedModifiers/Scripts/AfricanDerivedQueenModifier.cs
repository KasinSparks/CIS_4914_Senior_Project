 ...
 */
[CreateAssetMenu(menuName = "Card/Modifier/African Derived Queen")]
public class AfricanDerivedQueenModifier : CardModifier
{
    ...
    override public void ApplyModifier(Card card, Card other)
    {
        switch (card.GetOwnership())
        {
            ...
            default:
                throw new System.Exception("Tried to apply the African Queen modifier to a card with neither player or opponent ownership.");
        }
    ...
    public class ModifierSaveData : CardModifierSaveData
    {
        ...
        public ModifierSaveData(AfricanDerivedQueenModifier modifier) : base(modifier)
        {
